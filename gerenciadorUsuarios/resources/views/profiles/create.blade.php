                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="max-w-7xl mx-auto p-6 lg:p-8">
                        <div class="flex justify-center">
                            ...
                            <h2 class="ml-4 mt-6 text-xl font-semibold text-gray-900 dark:text-white">Criar Perfil</h2>
                        </div>
                                ...
                                <form action="/profiles/store" method="POST">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea id="description" name="description" rows="4"
                                            class="w-full px-4 py-2 bg-gray-700 text-white rounded-lg border border-gray-600 focus:outline-none focus:ring-2 focus:ring-red-500"></textarea>
                                    </div>
                                    <button type="submit"
                                        class="w-full bg-red-500 hover:bg-red-600 text-white py-2 rounded-lg text-lg font-medium">Salvar Perfil</button>
                                </form>
                            </div>
                        </div>
